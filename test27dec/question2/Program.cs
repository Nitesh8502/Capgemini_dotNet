...
{
    public class TransactioninSales
    {
        ...
        public static TransactioninSales LastTransaction;
    ...
    public class TransactionService
    {
        public static void CreateNewTransaction()
        {
            ...
            Console.Write("Enter Customer namee");
            string customerName = Console.ReadLine();

            Console.Write("Enter item namee ");
            ...
            Console.Write("enter Purchase Amount in total: ");
            ...
            TransactioninSales.LastTransaction = new TransactioninSales
             {
                InvoiceNo = invoiceNo,
            ...
            TransactioninSales.HasLastTransaction = true;
            Console.WriteLine("transaction saved successfully.");
            Console.WriteLine($"status: {profitOrLossStatus}");
            Console.WriteLine($"profit or Loss Amount: {profitOrLossAmount:F2}");
        ...
        {
            if (!TransactioninSales
    .HasLastTransaction)
            {
                Console.WriteLine("no transaction availabll create a new transaction first.");
                return;
            }

            var transaction = TransactioninSales
    .LastTransaction;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                Console.WriteLine("1. ceate new transaction (Enter Purchase & Selling Details)");
                Console.WriteLine("2. View last transaction");
                Console.WriteLine("3. Calculate Profit/Loss (Recompute and Print)");
